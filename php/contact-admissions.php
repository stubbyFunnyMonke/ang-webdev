...
if (!empty($_POST)) {
   ...
   //its morbin time
    ...
    setInnerHTML($messageHeader, "[ADMISSIONS] New Message From " . $name);
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'New email from the Admissions Contact Us Form: ' . $subject;
       ...
       if (mail($toEmail, $emailSubject, $htmlContent, $headers))  {
           ...
           header('Location: ../admissions-thank-you.html');
       } else {
